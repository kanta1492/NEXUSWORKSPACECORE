    ...
    <div className="min-h-screen bg-[#F1F5F9] relative flex flex-col items-center justify-center p-6 select-none" id="auth-portal">
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl space-y-6">
          ...
          {/* Toggle register / login helper link (only if user already registered manually first) */}
          {storedCredentials && (
            <div className="text-center pt-2">
              <button
                ...
                className="text-[10.5px] text-[#06B6D4] hover:text-[#0891B2] hover:underline transition font-bold"
              >
